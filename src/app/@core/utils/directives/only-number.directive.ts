	...
	getName(e: any): string {
		if (e.key) {
			...
			if (e.keyCode && String.fromCharCode) {
				switch (e.keyCode) {
					case 8: keyStroke = 'Backspace'; break;
					case 9: keyStroke = 'Tab'; break;
					case 27: keyStroke = 'Escape'; break;
					case 37: keyStroke = 'ArrowLeft'; break;
					case 39: keyStroke = 'ArrowRight'; break;
					case 188: keyStroke = ','; break;
					case 190: keyStroke = '.'; break;
					case 109: keyStroke = '-'; break;										// minus in numbpad
					case 173: keyStroke = '-'; break;										// minus in alphabet keyboard in firefox
					case 189: keyStroke = '-'; break;										// minus in alphabet keyboard in chrome
					default: keyStroke = String.fromCharCode(e.keyCode); break;
				}
				return keyStroke;
			}
			return keyStroke;
